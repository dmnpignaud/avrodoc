...
function remoteContent(callback) {
    ...
    client_css.forEach(function (file) {
        ...
        html.push('<link rel="stylesheet" type="text/css" href="/documentation/' + css_file + '"/>');
    });
    client_js.forEach(function (file) {
        html.push('<script type="text/javascript" src="/documentation/' + file + '"></script>');
    });
    html.push('<script type="text/javascript" src="/documentation/dust-templates.js"></script>');
